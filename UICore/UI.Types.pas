...
type
  TCommandsNames = (help, node, check, update, quit, createwallet, openwallet, getwalletlist, createtoken, createtransfer,
  whoami, getbalance, buyom, domining, doeasybuyom);
  ...
  TDesktopForms = (fRegestrattion, fLogin, fNewTransaction, fVerification, fTransactionHistory, fTransaction, fMyAddress,
  fRestoreSelection, fEnterWods, fChooseCC, fApproveTrx, fWords);
