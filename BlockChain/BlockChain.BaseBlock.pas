...
type
  ...
  public
    ...
    procedure SignBlock(AWallet: TWallet; APreviousHash: THash; APreviosID: UInt64);
...
procedure TBaseBlock.SignBlock(AWallet: TWallet; APreviousHash: THash; APreviosID: UInt64);
var
  Buf: TMemoryStream;
  data, body: TBytes;
begin
