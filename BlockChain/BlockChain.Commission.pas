...
type
  ...
  public
    ...
    constructor Create(A—ommissionInfo: TCommissionTrxV0; LastBlockHash: THash); overload;
...
class operator TCommissionInfoV0.Add(buf1: TBytes; buf2: TCommissionInfoV0): TBytes;
var
  LData, RData: TBytes;
begin
  RData := buf1;
...
class operator TCommissionInfoV0.Add(buf2: TCommissionInfoV0; buf1: TBytes): TBytes;
var
  LData, RData: TBytes;
begin
  RData := buf1;
...
constructor TCommissionBlockV0.Create(A—ommissionInfo: TCommissionTrxV0; LastBlockHash: THash);
var
  Buf: TMemoryStream;
  data: TBytes;
begin
...
begin
  ...
  case NetState of
    ...
    TESTNET:
      FIllChar(Local—ommission, SizeOf(Local—ommission), 1);
    LABNET:
      FIllChar(Local—ommission, SizeOf(Local—ommission), 2);
  end;
...
begin
  ...
  case BaseBlock.GetHeader.VersionData of
    0:
      begin
        try
          var Trx: TCommissionTrxV0 := BaseBlock.GetDataWithoutHeader;
          var Info: TCommissionInfoV0 := Trx.CommissionInfo;
          Result := [Info.CommTransOrigCoin] + [Info.CommRecService] + [Info.CommTransTokenInside] + [Info.CommCreateToken] +
...
class operator TCommissionTrxV0.Add(buf1: TBytes; buf2: TCommissionTrxV0): TBytes;
var
  LData, RData: TBytes;
begin
  RData := buf1;
...
class operator TCommissionTrxV0.Add(buf2: TCommissionTrxV0; buf1: TBytes): TBytes;
var
  LData, RData: TBytes;
begin
  RData := buf1;
