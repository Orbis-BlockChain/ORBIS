...
type
  TRelogConfirmForm = class(TForm)
    ...
    procedure ExitRectangleClick(Sender: TObject);
    procedure ReLogRectangleClick(Sender: TObject);
  private
...
procedure TRelogConfirmForm.ExitRectangleClick(Sender: TObject);
begin
  //Нажатие на "Выйти"
end;
...
procedure TRelogConfirmForm.ReLogRectangleClick(Sender: TObject);
begin
  //Нажатие на "Сменить криптоконтейнер"
end;
