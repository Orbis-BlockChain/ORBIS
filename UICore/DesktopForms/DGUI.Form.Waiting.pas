...
begin
  GoProgress(20, 'Good Authorization');
end;

procedure TWaitingForm.Set40;
begin
  GoProgress(40, 'Good Version');
end;

procedure TWaitingForm.Set60;
begin
  GoProgress(60, 'Start download blocks');
end;

procedure TWaitingForm.Set100;
begin
  GoProgress(100, 'End download blocks');
end;

procedure TWaitingForm.StartWork(AObject: TObject);
begin
  Notifyer.Subscribe(Set20, nOnOkAuth);
  Notifyer.Subscribe(Set40, nOnGoodVersion);
  Notifyer.Subscribe(Set60, nOnStartDownalodBlocks);
  Notifyer.Subscribe(Set100, nOnEndDownloadBlocks);
