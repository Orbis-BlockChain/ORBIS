...
const
  ...
  PhraseRU17 = 'Стоимость выпуска токенав ORBC';
  ...
  PhraseRU126 = 'Транзакция отправлена в сеть успешно. Ожидайте подтверждения транзакции. После подтверждения ваша транзакция появится в вашем списке транзакций. Если она не появилась в списке транзакций более 30 секунд, то сеть отклонила вашу транзакцию.';
  PhraseRU127 = 'Вы являетесь участником DAO.';
  PhraseRU128 = 'Поздравляем, вы сгенерировали транзакцию на преобретение ОМ. Ожидайте подтверждение транзакции. После подтверждения ваша транзакция появится в вашем списке транзакций. Если она не появилась в'+
  ...
  PhraseEN126 = 'The transaction was successfully sent to the network. Wait for transaction confirmation. After confirmation, your transaction will be added to the list of'+
  ...
  PhraseEN128 = 'Congratulations, you have generated a transaction to purchase an OM. Wait for transaction confirmation. After confirmation, your transaction will be added to the list of transactions. If it does not appear in the'+
