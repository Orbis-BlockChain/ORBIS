...
begin
  ...
  begin
    ...
    ParentRect := Screen.WorkAreaRect;
  Text1.AutoSize := True;
  Text1.AutoSize := False;
  ToastRect := TRect.Create(TPoint.Zero, Round(Text1.Width) + 45, Round(Text1.Height) + 30);
  SetBounds((ParentRect.Left - (ToastRect.Width - ParentRect.Width) div 2) - 2, ParentRect.Top + 158, ToastRect.Width,
  ToastRect.Height);
...
procedure TToastForm.FormMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Single);
begin
  StartHide;
end;
